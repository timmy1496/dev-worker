...
class User
{
    ...
    {
        if ($this->joinConfirmToken && $this->joinConfirmToken->isEmtpy()) {
            $this->joinConfirmToken = null;
        }
        if ($this->passwordResetToken && $this->passwordResetToken->isEmtpy()) {
            $this->passwordResetToken = null;
        }
        if ($this->newEmailToken && $this->newEmailToken->isEmtpy()) {
            $this->newEmailToken = null;
        }
    }
}
